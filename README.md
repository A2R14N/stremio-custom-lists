# Stremio Custom Lists Addon

![Stremio](https://img.shields.io/badge/Stremio-Addon-purple?style=for-the-badge&logo=stremio)

A Stremio addon constructed to manage and serve user-curated custom JSON catalogs directly to your Stremio client. This addon natively fetches Trakt.tv lists down to local storage, creating an lightning fast, offline metadata map bypassing rate limit delays!
